...
@section('subtitle', 'Tambah UMKM baru ke database')
    ...
    <div class="col-md-8">
        <div class="admin-card">
            <div class="admin-card-header">
                <h5 class="mb-0"><i class="fas fa-plus me-2"></i>Tambah UMKM Baru</h5>
            </div>
            <div class="card-body">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select @error('category') is-invalid @enderror" 
                                            ...
                                            <option value="kayu" {{ old('category') == 'kayu' ? 'selected' : '' }}>Kayu</option>
